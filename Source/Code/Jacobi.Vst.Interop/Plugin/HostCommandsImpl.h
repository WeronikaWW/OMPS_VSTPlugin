...
namespace Interop {
    ...
    /// </summary>
    private ref class HostCommandsImpl : Jacobi::Vst::Core::IVstHostCommands20,
    ...
    public:
        ...
        System::Boolean UpdatePluginInfo(Jacobi::Vst::Core::Plugin::VstPluginInfo^ pluginInfo);
        ...
        virtual System::IntPtr GetPreviousPlugin(System::Int32 pinIndex); // Vst2Plugin*
        /// <summary>
        /// Retrieves the next Plugin based on the specified <paramref name="pinIndex"/>.
        /// </summary>
        /// <param name="pinIndex">A zero-based pin index. Specify -1 for next.</param>
        /// <returns>Return System.IntPtr.Zero when unsuccessful.</returns>
        virtual System::IntPtr GetNextPlugin(System::Int32 pinIndex); // Vst2Plugin*
        /// <summary>
        ...
        /// <returns>Returns True when the call was successful.</returns>
        virtual System::Boolean SetIcon(System::IntPtr icon);
        /// <summary>
