namespace Jacobi.Vst.Plugin.Framework
{
    ...
    public class VstProductInfo
    {
        ...
        {
            Throw.IfArgumentIsNullOrEmpty(product, nameof(product));
            Throw.IfArgumentIsNullOrEmpty(vendor, nameof(vendor));
            Throw.IfArgumentTooLong(product, Core.Constants.MaxProductStringLength, nameof(product));
            Throw.IfArgumentTooLong(vendor, Core.Constants.MaxVendorStringLength, nameof(vendor));
