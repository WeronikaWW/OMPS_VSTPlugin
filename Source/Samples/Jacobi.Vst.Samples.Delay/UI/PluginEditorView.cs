...
namespace Jacobi.Vst.Samples.Delay.UI
{
    public partial class PluginEditorView : UserControl
    {
        ...
        internal bool InitializeParameters(IList<VstParameterManager> parameters)
        {
            ...
            BindParameter(parameters[4], label9, trackBar5, label14);
            BindParameter(parameters[5], label10, trackBar6, label15);
            BindParameter(parameters[6], label11, trackBar7, label16);
            BindParameter(parameters[7], label12, trackBar8, label17);
            BindParameter(parameters[8], label13, trackBar9, label18);
